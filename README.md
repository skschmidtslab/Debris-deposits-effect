...
5. Physeq_diversity_Euk.R: Script for phyloseq object construction using 18S data. It follows the same processing steps as the prokaryotic workflow for consistency.
...
Note: Plots were improve in color, format and resolution in Inkscape.
